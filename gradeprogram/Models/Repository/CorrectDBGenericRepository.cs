...
{
    public class CorrectDBGenericRepository<TEntity> : IRepository<TEntity>
        where TEntity : class
    {
        ...
        public CorrectDBGenericRepository()
            : this(new CorrectStuHWDBEntities())
        {
        }
        public CorrectDBGenericRepository(DbContext context)
        {
            if (context == null)
            {
        ...
        public CorrectDBGenericRepository(ObjectContext context)
        {
            if (context == null)
            {
                throw new ArgumentNullException("context");
